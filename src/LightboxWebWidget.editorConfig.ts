...
export function getProperties(
    _values: LightboxWebWidgetPreviewProps,
...
// export function getCustomCaption(values: LightboxWebWidgetPreviewProps, platform: Platform): string {
//     return "LightboxWebWidget";
// }
